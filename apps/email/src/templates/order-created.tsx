    ...
    <Html lang="vi">
      ...
      <Body style={main}>
        <Container style={container}>
          ...
          <Text style={text}>
            Cảm ơn bạn đã đặt hàng. Đơn hàng <strong>#{orderId}</strong> của bạn
            đã được xác nhận.
          </Text>
          ...
          <Section style={section}>
            ...
            <Row style={itemRow}>
              <Column>
                <Text style={text}>Tạm tính</Text>
              </Column>
              <Column style={priceCol}>
                <Text style={text}>{formatCurrency(subtotal)}</Text>
              </Column>
            </Row>
            <Row style={itemRow}>
              <Column>
                <Text style={text}>Phí vận chuyển</Text>
              </Column>
              <Column style={priceCol}>
                <Text style={text}>{formatCurrency(shippingFee)}</Text>
              </Column>
            </Row>
            <Row style={itemRow}>
              <Column>
